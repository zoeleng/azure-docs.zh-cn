...
9. 更新需要数小时才能完成。 随时可以选择更新作业并单击“详细信息”来查看作业详细信息。
    ...
    ![更新作业创建2](./media/storsimple-8000-install-update4-via-portal/update8.png)

     还可以从“设备设置”>“作业”检索更新作业的进度。 在“作业”边栏选项卡上，可以看到更新进度。

     ![更新作业创建3](./media/storsimple-8000-install-update4-via-portal/update7.png)

10. 在作业完成后，导航到“设备设置”>“设备更新”。 软件版本现在应当已更新。

   ![更新作业创建4](./media/storsimple-8000-install-update4-via-portal/update9.png)
