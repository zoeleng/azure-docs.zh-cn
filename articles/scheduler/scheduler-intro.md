...
其他 Azure 计划功能也在后台使用计划程序，例如，[Azure WebJobs](../app-service/webjobs-create.md)，这是 Azure 应用服务中的一个 [Web 应用](https://azure.microsoft.com/services/app-service/web/)功能。 可以使用[计划程序 REST API](/rest/api/scheduler/) 来管理这些操作的通信，该 API 可以帮助你管理这些操作的通信。
