...
3. 可以使用 Microsoft 访问面板。 在访问面板中单击 Software AG Cloud 磁贴时，将会重定向到 Software AG Cloud 登录 URL。 有关访问面板的详细信息，请参阅[访问面板简介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
