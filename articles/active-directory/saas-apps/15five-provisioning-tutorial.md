...
> * 在15Five 中预配组和组成员身份
> * [单一登录](./15five-tutorial.md) 到 15Five (建议) 
...
从 Azure AD 应用程序库中添加15Five，开始管理预配到15Five。 如果以前为 SSO 设置了15Five，则可以使用相同的应用程序。 但建议你在最初测试集成时创建一个单独的应用。 可在[此处](../manage-apps/add-application-portal.md)详细了解如何从库中添加应用程序。 
