...
1. 在 [Azure 门户](https://portal.azure.com/)的“OneTrust Privacy Management Software”应用程序集成页上，选项“单一登录”   。
...
当在访问面板中单击 OneTrust Privacy Management Software 磁贴时，应会自动登录到设置了 SSO 的 OneTrust Privacy Management Software。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
