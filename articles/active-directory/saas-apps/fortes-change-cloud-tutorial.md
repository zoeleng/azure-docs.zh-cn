...
## <a name="configure-and-test-azure-ad-single-sign-on-for-fortes-change-cloud"></a>配置并测试 Fortes Change Cloud 的 Azure AD 单一登录

使用名为 B.Simon 的测试用户配置并测试 Fortes Change Cloud 的 Azure AD SSO。 若要使 SSO 有效，需要在 Azure AD 用户与 Fortes Change Cloud 相关用户之间建立关联。

若要配置并测试 Fortes Change Cloud 的 Azure AD SSO，请完成以下构建基块：
...
1. 在 [Azure 门户](https://portal.azure.com/)中的”Fortes Change Cloud”应用程序集成页上，找到“管理”部分并选择“单一登录” 。
...
1. 如果要在“IDP”发起的模式下配置应用程序，请在“基本 SAML 配置”部分中输入以下字段的值 ：
    ...
    a. 在“标识符”文本框中，使用以下模式键入 URL：`https://<identifier>.fortes-online.com/saml/metadata`

    b. 在“回复 URL”文本框中，使用以下模式键入 URL：`https://<identifier>.fortes-online.com/saml/SSO`

1. 如果要在 SP 发起的模式下配置应用程序，请单击“设置其他 URL”，并执行以下步骤：

    在“登录 URL”文本框中，使用以下模式键入 URL：`https://<identifier>.fortes-online.com/saml/SSO`
...
单击访问面板中的“Fortes Change Cloud”磁贴时，应当会自动登录到为其设置了 SSO 的 Fortes Change Cloud。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
...
- [在 Azure AD 中试用 Fortes Change Cloud](https://aad.portal.azure.com/)

- [Microsoft Cloud App Security 中的会话控制是什么？](/cloud-app-security/proxy-intro-aad)

- [如何使用高级可见性和控制保护 Fortes Change Cloud](/cloud-app-security/proxy-intro-aad)