...
> [!TIP]
> 你还可以选择按照 [Soloinsight-CLOUDGATE SSO 单一登录教程](./soloinsight-cloudgate-sso-tutorial.md)中提供的说明为 Soloinsight-CloudGate SSO 启用基于 SAML 的单一登录。 可以独立于自动用户预配配置单一登录，尽管这两个功能互相补充
