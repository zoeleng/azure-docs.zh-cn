...
## <a name="configure-and-test-azure-ad-single-sign-on-for-deskradar"></a>配置和测试 Deskradar 的 Azure AD 单一登录
...
1. 在 [Azure 门户](https://portal.azure.com/)的 Deskradar 应用程序集成页面上，找到“管理”部分，选择“单一登录”    。
...
单击访问面板中的 Deskradar 磁贴时，会自动登录到为其设置了 SSO 的 Deskradar。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
...
- [尝试 Deskradar 与 Azure AD 集成](https://aad.portal.azure.com/)