...
1. 转到“用户详细信息\>添加用户”。
    ...
    ![显示 Zoho 邮件网站的屏幕截图，其中选择了“用户详细信息”和“添加用户”。](./media/zoho-mail-tutorial/ic789611.png "添加用户")

1. 在“添加用户”  对话框中，执行以下步骤：
   
    ![显示“添加用户”对话框的屏幕截图，可在其中输入所述值。](./media/zoho-mail-tutorial/ic789612.png "添加用户")
...
单击访问面板中的 Zoho 磁贴时，应当会自动登录到为其设置了 SSO 的 Zoho。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
