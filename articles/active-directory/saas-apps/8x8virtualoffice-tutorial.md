...
在访问面板中单击“8x8”磁贴时，应会自动登录到设置了 SSO 的 8x8。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
...
- [如何使用高级可见性和控制保护 8x8](/cloud-app-security/proxy-intro-aad)