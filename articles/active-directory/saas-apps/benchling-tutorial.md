...
## <a name="configure-and-test-azure-ad-single-sign-on-for-benchling"></a>配置并测试 Benchling 的 Azure AD 单一登录

使用名为 **B.Simon** 的测试用户配置并测试 Benchling 的 Azure AD SSO。 若要正常使用 SSO，需要在 Azure AD 用户与 Benchling 中的相关用户之间建立链接关系。

若要配置并测试 Benchling 的 Azure AD SSO，请完成以下构建基块：
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“Benchling”应用程序集成页上，找到“管理”部分并选择“单一登录”。   
...
在访问面板中单击“Benchling”磁贴时，应会自动登录到设置了 SSO 的 Benchling。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
...
- [在 Azure AD 中试用 Benchling](https://aad.portal.azure.com/)