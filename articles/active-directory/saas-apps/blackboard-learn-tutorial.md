...
## <a name="configure-and-test-azure-ad-single-sign-on-for-blackboard-learn"></a>配置并测试 Blackboard Learn 的 Azure AD 单一登录

使用名为 **B.Simon** 的测试用户配置并测试 Blackboard Learn 的 Azure AD SSO。 若要正常使用 SSO，需要在 Azure AD 用户与 Blackboard Learn 中的相关用户之间建立链接关系。

若要配置并测试 Blackboard Learn 的 Azure AD SSO，请完成以下构建基块：
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“Blackboard Learn”应用程序集成页上，找到“管理”部分并选择“单一登录”。   
...
在本部分中，在 Blackboard Learn 中创建名为 Britta Simon 的用户。 Blackboard Learn 应用程序支持准时用户预配。 确保已根据 **配置 Azure AD 单一登录** 部分中所述配置了声明。

## <a name="test-sso"></a>测试 SSO

在本部分中，使用访问面板测试 Azure AD 单一登录配置。

单击访问面板中的 Blackboard Learn 磁贴时，应当会自动登录到为其设置了 SSO 的 Blackboard Learn。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](../user-help/my-apps-portal-end-user-access.md)（访问面板简介）。
...
- [在 Azure AD 中试用 Blackboard Learn](https://aad.portal.azure.com/)