...
1. 使用工作或学校帐户或个人 Microsoft 帐户登录到 [Azure 门户](https://portal.azure.com)。 或者，登录到适用于国家云的[所选 Azure 门户](./authentication-national-cloud.md#app-registration-endpoints)。
...
转到本方案中的下一篇文章 [应用的代码配置](scenario-web-app-sign-user-app-configuration.md)。