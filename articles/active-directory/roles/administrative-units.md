...
例如，委派给区域支持专家[支持管理员](permissions-reference.md#helpdesk-administrator)角色，该角色限制为仅管理其支持的区域中的用户。
...
- [创建、删除、填充角色并将其添加到管理单元](admin-units-manage.md)：完成操作指南过程
...
- [管理 AU](admin-units-manage.md)
- [管理 AU 中的用户](admin-units-add-manage-users.md)
- [管理 AU 中的组](admin-units-add-manage-groups.md)
- [将范围角色分配给 AU](admin-units-assign-roles.md)
