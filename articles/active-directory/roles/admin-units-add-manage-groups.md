...
1. 通过“Azure AD”>“组”页
    ...
    ![将组一个一个地分配给管理单元](./media/admin-units-add-manage-groups/assign-to-group-1.png)
...
1. 通过“Azure AD”>“管理单元”>“所有组”页
    ...
    ![选择一个管理单元，然后选择“添加成员”](./media/admin-units-add-manage-groups/assign-to-admin-unit.png)
...
![列出管理单元中的组](./media/admin-units-add-manage-groups/list-groups-in-admin-units.png)
...
![列出组的管理单元](./media/admin-units-add-manage-groups/list-group-au.png)
...
- 从组中删除概述
  ...
  1. 在左面板中选择“管理单元”以列出该组所属的所有管理单元。 选择要从中删除组的管理单元，然后选择“从管理单元中删除”。
    ...
    ![从管理单元删除组](./media/admin-units-add-manage-groups/group-au-remove.png)
