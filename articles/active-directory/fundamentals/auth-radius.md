...
* [使用 NPS 提供 Azure AD 多重身份验证功能](https://docs.microsoft.com/azure/active-directory/authentication/howto-mfa-nps-extension) 

* [配置 Azure AD 多重身份验证 NPS 扩展](https://docs.microsoft.com/azure/active-directory/authentication/howto-mfa-nps-extension-advanced) 

* [使用 NPS 扩展进行 Azure AD 多重身份验证的 VPN](https://docs.microsoft.com/azure/active-directory/authentication/howto-mfa-nps-extension-vpn) 
