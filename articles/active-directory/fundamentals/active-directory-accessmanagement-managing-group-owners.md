...
3. 在“MDM 策略 - 西部概述”页面上，选择“所有者”   。
    ...
    ![MDM 策略-突出显示了 "删除所有者" 选项的 "西部概述" 页](media/active-directory-accessmanagement-managing-group-owners/remove-owners-option-overview-blade.png)
