...
本文将帮助你删除虚拟网络网关。 如果要删除 VPN 网关配置的网关，可以采用几种不同的方法。
...
> [!IMPORTANT]
> 本文中的步骤适用于 Resource Manager 部署模型。 若要删除使用经典部署模型部署的 VPN 网关，请使用 [删除网关：经典一](vpn-gateway-delete-vnet-gateway-classic-powershell.md) 文中的步骤。
