...
Azure Monitor 提供了一个指标的 *已连接设备* ，可用于监视连接到 IoT 中心的设备数，并在连接的设备数降到阈值以下时触发警报。 虽然这在某些情况下可能已足够，但 [Azure 事件网格](/azure/event-grid/) 提供低延迟的每设备监视解决方案，可用于跟踪关键设备和基础结构的设备连接。
