...
| 切片名称 | 说明                                                                                                                                                                                                                                                                                                |
|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Domain     | 域切片包括在 Internet 域中找到的所有内容。 例如 `www.microsoft.com`。 省略 `www.` 会导致必应同时搜索该域的子域。 例如，如果指定 `microsoft.com` ，必应还会从或返回 `support.microsoft.com` 结果 `technet.microsoft.com` 。 |
...
如果在适当级别订阅了自定义搜索（请参阅  。 “统计信息”选项卡显示有关如何使用自定义搜索终结点的详细信息，包括调用量、热门查询、地理分布、响应代码和安全搜索。 可以使用提供的控件筛选详细信息。
