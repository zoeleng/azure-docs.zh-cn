...
* [将诊断设置用于 Azure 认知服务](./diagnostic-logging.md)
...
* [如何重新生成 Redis 访问密钥的 Azure 缓存](../azure-cache-for-redis/cache-configure.md#settings)
...
* [如何对认知服务请求进行身份验证](./authentication.md#authenticate-with-azure-active-directory)
