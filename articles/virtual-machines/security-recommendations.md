...
| 使 VM 保持最新。 | 可以使用 Azure 自动化中的[更新管理](../automation/update-management/update-mgmt-overview.md)解决方案来管理 Azure 中 Windows 和 Linux 计算机的操作系统更新。 | [是](../security-center/security-center-apply-system-updates.md) |
...
请与应用程序提供商联系，了解其他安全要求。 有关开发安全应用程序的详细信息，请参阅 [安全开发文档](../security/fundamentals/abstract-develop-secure-apps.md)。