...
description: 本文提供了对 Linux Vm 使用 Microsoft Azure 磁盘加密的先决条件。
author: msmbaldwin
...
### <a name="create-a-key-vault-with-powershell"></a><a name="bkmk_KVPSH"></a> 使用 PowerShell 创建密钥保管库
...
### <a name="create-a-key-vault-with-azure-cli"></a><a name="bkmk_KVCLI"></a> 使用 Azure CLI 创建密钥保管库
...
### <a name="create-a-key-vault-with-a-resource-manager-template"></a><a name="bkmk_KVRM"></a> 使用资源管理器模板创建密钥保管库
...
## <a name="set-up-an-azure-ad-app-and-service-principal"></a><a name="bkmk_ADapp"></a> 设置 Azure AD 的应用程序和服务主体 
...
## <a name="set-the-key-vault-access-policy-for-the-azure-ad-app"></a><a name="bkmk_KVAP"></a> 为 Azure AD 应用设置密钥保管库访问策略
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-cli"></a><a name="bkmk_KVAPCLI"></a> 使用 Azure CLI 为 Azure AD 应用设置密钥保管库访问策略
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-the-portal"></a><a name="bkmk_KVAPRM"></a> 使用门户为 Azure AD 应用设置密钥保管库访问策略
...
## <a name="set-key-vault-advanced-access-policies"></a><a name="bkmk_KVper"></a> 设置密钥保管库高级访问策略
Azure 平台需要访问 Key Vault 中的加密密钥或机密，才能使这些密钥和机密可供 VM 用来启动和解密卷。 对 Key Vault 启用磁盘加密，否则部署将会失败。  

### <a name="set-key-vault-advanced-access-policies-with-azure-powershell"></a><a name="bkmk_KVperPSH"></a> 使用 Azure PowerShell 设置密钥保管库高级访问策略
...
### <a name="set-key-vault-advanced-access-policies-using-the-azure-cli"></a><a name="bkmk_KVperCLI"></a> 使用 Azure CLI 设置密钥保管库高级访问策略
...
### <a name="set-key-vault-advanced-access-policies-through-the-azure-portal"></a><a name="bkmk_KVperrm"></a> 通过 Azure 门户设置密钥保管库的高级访问策略
