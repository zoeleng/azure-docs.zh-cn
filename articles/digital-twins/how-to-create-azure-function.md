...
可以通过将 SDK 添加到 function app 来编写 Azure function。 函数应用使用 [用于 .net 的 Azure 数字孪生 SDK (c # ) ](/dotnet/api/overview/azure/digitaltwins/client?view=azure-dotnet-preview&preserve-view=true)与 Azure 数字孪生交互。 
