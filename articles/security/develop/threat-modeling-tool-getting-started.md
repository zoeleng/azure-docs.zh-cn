...
![屏幕截图显示威胁属性窗口，其中包含标题、类别、说明、交互和优先级。](./media/threat-modeling-tool-getting-started/interactioninfo.png)
...
![屏幕截图显示了具有代表性的威胁建模报告。](./media/threat-modeling-tool-feature-overview/report.png)
