...
你还可以直接查询指标 Log Analytics。 通过 Log Analytics 查询入门详细了解它 (https://docs.microsoft.com/azure/azure-monitor/insights/container-insights-log-search) 
