...
2. 在上一步骤下载的 GitHub 存储库中，导航到“Azure 资源管理器”文件夹，并打开名为   
...
2. 在“数据资源管理器”窗格中，选择“新建集合”并在表单中填写以下详细信息：   
   ...
   * 对于“数据库 ID”字段，请选择“新建”，然后输入  将“预配数据库吞吐量”框保留未选中状态。   
   * 对于“集合 ID”字段，请输入   
   * 对于“分区键”字段，请输入  此值区分大小写，因此请务必正确输入。  
   * 对于“吞吐量”字段，请输入   
   * 选择“确定”按钮。  
