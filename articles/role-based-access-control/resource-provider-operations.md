...
> | Microsoft.Sql/servers/databases/dataWarehouseUserActivities/read | 检索 Azure Synapse Analytics 专用 SQL 池（包括正在运行和已挂起的查询）的用户活动 |
...
> | KeyVault/保管库/密钥/写入 | 创建新的密钥或更新现有的密钥。 |
