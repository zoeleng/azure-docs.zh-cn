...
2. 在“创建 Web 应用”的“基本信息”选项卡中，输入或选择以下信息 ：
    ...
    | 区域 | 选择“美国东部” |
    | **应用服务计划** |  |
    | Windows 计划（美国东部） | 选择“新建”。 </br> 在“名称”中输入 myServicePlan 。 |
...
10. 验证是否收到 403 页面。 此页面指示无法从外部访问 Web 应用。
    ...
    :::image type="content" source="./media/tutorial-private-endpoint-webapp-portal/web-app-ext-403.png" alt-text="Azure 门户中“创建 Web 应用”的“基本信息”选项卡。" border="true":::
...
13. 验证是否收到默认 Web 应用页面。
    ...
    :::image type="content" source="./media/tutorial-private-endpoint-webapp-portal/web-app-default-page.png" alt-text="Azure 门户中“创建 Web 应用”的“基本信息”选项卡。" border="true":::
