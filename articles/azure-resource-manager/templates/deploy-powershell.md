...
如果尚未安装 PowerShell，可以使用 Cloud Shell。 有关详细信息，请参阅 [从 Cloud Shell 部署 ARM 模板](deploy-cloud-shell.md)。
...
若要部署本地模板，请 `-TemplateFile` 在部署命令中使用参数。 下面的示例还演示如何设置来自模板的参数值。
