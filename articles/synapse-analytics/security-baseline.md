...
**指南** ： Azure Active Directory 没有默认密码的概念。 预配专用 SQL 池时，建议选择将身份验证与 Azure Active Directory 集成。 使用此身份验证方法时，用户将提交用户帐户名，并请求服务使用 Azure Active Directory (Azure AD) 中存储的凭据信息。
