...
- 本操作方法指南假设你已使用 Azure Key Vault 的密钥作为 Azure SQL 数据库或 Azure Synapse 的 TDE 保护程序， (以前的 SQL 数据仓库) 。 有关详细信息，请参阅[支持 BYOK 的透明数据加密](transparent-data-encryption-byok-overview.md)。
