...
> [!NOTE]
> 如果上述信息无法使同步组摆脱“正在处理”状态，可让 Microsoft 支持部门重置该同步组的状态。 若要重置同步组状态，请在 [AZURE SQL 数据库的 Microsoft Q&问题页](/answers/topics/azure-sql-database.html)中，创建 post。 在贴子中，请包含自己的订阅 ID，以及需要重置的组的同步组 ID。 Microsoft 支持工程师将会回复帖子，并在重置状态后予以通知。
