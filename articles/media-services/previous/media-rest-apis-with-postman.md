...
3. 在屏幕的右侧，选择“管理环境”选项。
    ...
    ![屏幕截图显示选定的 "管理环境" 选项。](./media/media-services-rest-upload-files/postman-create-env.png)
4. 从“管理环境”对话框中，单击“导入”。
...
8. 选择 **AzureMedia** 环境。
    ...
    ![屏幕截图显示选定的 AzureMedia 环境。](./media/media-services-rest-upload-files/postman-choose-env.png)
...
3. 选择 **AzureMediaServicesOperations.postman_collection.json** 文件。
    ...
    ![屏幕截图显示 "导入" 对话框，其中选择了 "选择文件"。](./media/media-services-rest-upload-files/postman-import-collection.png)
