...
请尝试 [使用客户托管的密钥，或使用媒体服务将自己的密钥 (BYOK) ](tutorial-byok.md) ，以了解如何使用 Postman 和 Azure REST API 设置和使用客户托管密钥。

## <a name="next-steps"></a>后续步骤

* [教程：使用客户托管的密钥，或使用 Media Services 将自己的密钥 (BYOK) ](tutorial-byok.md)
