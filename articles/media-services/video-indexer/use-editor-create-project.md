...
1. 单击 " **创建新项目** "。  
    ...
    ![显示 "视频索引器" 页并选中 "项目" 选项卡的屏幕截图。](./media/video-indexer-view-edit/new-project.png)
...
1. 通过选择 " **添加视频** "，添加要在此项目中使用的视频。
    ...
    ![屏幕截图显示了介绍 GitHub 的视频，其中包含两个结果。](./media/video-indexer-view-edit/github.png)
...
1. 现在，你将看到所选的所有视频。 这些是你要从中选择项目剪辑的视频。
    ...
    ![屏幕截图显示视频索引器，其中包含要删除、清除选择或下移的视频之一的上下文菜单。](./media/video-indexer-view-edit/rearrange.png)
...
1. 通过选择 " **筛选器选项** "，添加筛选器以进一步指定你要查找的场景的详细信息。
    ...
    ![屏幕截图显示了包含筛选器的已选择人员的视频索引器。](./media/video-indexer-view-edit/include.png)
    
    如果需要在 Donovan _棕色不在屏幕上时_ 提到 GitHub 的剪辑，只需使用下拉列表将 "包含" 筛选器更改为 "排除" 筛选器。 
...
![屏幕截图显示视频索引器以及窗口右侧视频的预览。](./media/video-indexer-view-edit/preview.png)
...
1. 完成后，请确保已保存项目。 现在可以呈现此项目。 选择 " **呈现" 和 "下载** "。 
    ...
    ![屏幕截图显示视频索引器，其中包含用于呈现和下载项目的选项。](./media/video-indexer-view-edit/save.png)
