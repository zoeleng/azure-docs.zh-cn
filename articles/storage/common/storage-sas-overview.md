...
- **使用 Azure Monitor 和 Azure 存储日志来监视应用程序。** 你可以使用 Azure Monitor 和存储分析日志记录来观察由于 SAS 提供程序服务中断或无意中删除存储访问策略而导致的授权失败的任何高峰。 有关详细信息，请参阅 [Azure Monitor 中的 Azure 存储指标](monitor-storage.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json)和 [Azure 存储分析日志记录](storage-analytics-logging.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json)。
