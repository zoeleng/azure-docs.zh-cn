...
ms.locfileid: "92488871"
---
# <a name="azure-security-baseline-for-azure-storage"></a>Azure 存储的 azure 安全基线

Azure 存储空间的 Azure 安全基线包含的建议可帮助你提高部署的安全状况。

此服务的基线摘自 [Azure 安全基准版本 1.0](/azure/security/benchmarks/overview)，其中提供了有关如何根据我们的最佳做法指导保护 Azure 上的云解决方案的建议。

有关详细信息，请参阅 [Azure 安全基线概述](/azure/security/benchmarks/security-baselines-overview)。

## <a name="network-security"></a>网络安全

有关详细信息，请参阅[安全控制：网络安全性](/azure/security/benchmarks/security-control-network-security)。
...
- [如何配置 Azure 存储防火墙](/azure/storage/common/storage-network-security#change-the-default-network-access-rule)

- [如何配置 Azure 存储的专用终结点](/azure/storage/common/storage-private-endpoints)
...
- [配置 Azure 存储防火墙和虚拟网络](/azure/storage/common/storage-network-security)

- [如何启用 NSG 流日志](/azure/network-watcher/network-watcher-nsg-flow-logging-portal)

- [了解 Azure 安全中心提供的网络安全](/azure/security-center/security-center-network-recommendations)

- [了解 Azure 存储的专用终结点](/azure/storage/common/storage-private-endpoints#known-issues)
...
- [如何启用高级威胁防护](/azure/storage/common/storage-advanced-threat-protection?tabs=azure-portal)
...
- [在门户中使用 Azure 网络观察程序管理数据包捕获](/azure/network-watcher/network-watcher-packet-capture-manage-portal)
...
- [配置 Azure 存储的高级威胁防护](/azure/storage/common/storage-advanced-threat-protection)
...
- [有关使用服务标记的详细信息](/azure/virtual-network/service-tags-overview)

- [有关 Azure 存储的虚拟网络服务终结点策略的详细信息](/azure/virtual-network/virtual-network-service-endpoint-policies-overview)
...
- [适用于存储的 Azure 策略示例](/azure/governance/policy/samples/built-in-policies#storage)

- [用于网络的 Azure 策略示例](/azure/governance/policy/samples/built-in-policies#network)

- [如何创建 Azure 蓝图](/azure/governance/blueprints/create-blueprint-portal)
...
- [如何创建虚拟网络](/azure/virtual-network/quick-create-portal)

- [如何创建采用安全配置的 NSG](/azure/virtual-network/tutorial-filter-network-traffic)
...
- [如何配置 Azure 存储帐户的监视](/azure/storage/common/storage-monitor-storage-account#configure-monitoring-for-a-storage-account)
...
- [记录和检查数据](/azure/storage/common/storage-analytics-logging#how-logs-are-stored)
...
- [如何加入 Azure Sentinel](/azure/sentinel/quickstart-onboard)

- [如何在 Azure 安全中心管理警报](/azure/security-center/security-center-managing-and-responding-alerts)

- [如何针对 Log Analytics 日志数据发出警报](/azure/azure-monitor/learn/tutorial-response)

- [Azure 存储分析日志记录](/azure/storage/common/storage-analytics-logging)
...
- [配置 Azure 存储的高级威胁防护](/azure/storage/common/storage-advanced-threat-protection?tabs=azure-portal)
...
- [使用 DNS Analytics 预览解决方案收集有关 DNS 基础结构的见解](/azure/azure-monitor/insights/dns-analytics)
...
- [授予访问 Azure 存储中的数据的权限](/azure/storage/common/storage-auth)

- [了解 Azure 存储帐户的安全主体和访问控制](/azure/storage/common/storage-introduction)
...
- [了解 Azure 安全中心标识和访问](/azure/security-center/security-center-identity-access)
...
- [使用 Azure Active Directory 授予对 Blob 和队列的访问权限](/azure/storage/common/storage-auth-aad)
...
- [如何在 Azure 安全中心监视标识和访问](/azure/security-center/security-center-identity-access)
...
- [如何设置 Azure 存储帐户的高级威胁防护](/azure/storage/common/storage-advanced-threat-protection)
...
- [如何在 Azure 中配置命名位置](/azure/active-directory/reports-monitoring/quickstart-configure-named-locations)
...
- [使用 Azure 存储资源提供程序访问管理资源](/azure/storage/common/authorization-resource-provider)

- [如何使用 Azure RBAC 在 Azure 门户中配置对 Azure Blob 和队列数据的访问权限](/azure/storage/common/storage-auth-aad-rbac-portal)

- [授予访问 Azure 存储中的数据的权限](/azure/storage/common/storage-auth)

- [使用共享访问签名 (SAS) 授予对 Azure 存储资源的有限访问权限](/azure/storage/common/storage-sas-overview)
...
- [如何查看和更改 Azure 存储帐户级别的访问权限](/azure/storage/common/storage-auth-aad-rbac-portal)

- [使用共享访问签名 (SAS) 授予对 Azure 存储资源的有限访问权限](/azure/storage/common/storage-sas-overview)

- [管理对容器和 Blob 的匿名读取访问](/azure/storage/blobs/storage-manage-access-to-resources)

- [在 Azure 门户中监视存储帐户](/azure/storage/common/storage-monitor-storage-account)

- [管理存储帐户访问密钥](/azure/storage/common/storage-account-keys-manage)
...
- [如何配置 Azure 存储帐户的指标警报](/azure/storage/common/storage-monitor-storage-account)
...
- [如何配置和启用标识保护风险策略](/azure/active-directory/identity-protection/howto-identity-protection-configure-risk-policies)
...
- [了解客户密码箱](/azure/security/fundamentals/customer-lockbox-overview)
...
- [虚拟网络服务终结点](/azure/virtual-network/virtual-network-service-endpoints-overview)
...
- [配置 Azure 存储防火墙和虚拟网络](/azure/virtual-network/virtual-network-service-endpoint-policies-overview)

- [Azure 存储的虚拟网络服务终结点策略](/azure/private-link/create-private-endpoint-storage-portal)

- [了解 Azure 中的客户数据保护](/azure/security/fundamentals/protection-customer-data)
...
- [如何在 Azure 存储中要求安全传输](/azure/storage/common/storage-require-secure-transfer)

- [通过安全中心监视的 Azure 安全策略](/azure/security-center/security-center-policy-definitions)
...
- [如何为 Azure 存储帐户分配 Azure 角色](/azure/storage/common/storage-auth-aad-rbac-portal#assign-azure-roles-using-the-azure-portal)

- [使用 Azure 存储资源提供程序访问管理资源](/azure/storage/common/authorization-resource-provider)

- [如何使用 Azure RBAC 在 Azure 门户中配置对 Azure Blob 和队列数据的访问权限](/azure/storage/common/storage-auth-aad-rbac-portal)

- [如何创建和配置 AAD 实例](/azure/active-directory/fundamentals/active-directory-access-create-new-tenant)
...
- [了解静态 Azure 存储加密](/azure/storage/common/storage-service-encryption)
...
- [安全建议 - 参考指南](/azure/security-center/recommendations-reference)
...
- [如何使用 Azure Graph 创建查询](/azure/governance/resource-graph/first-query-portal)

- [如何查看 Azure 订阅](/powershell/module/az.accounts/get-azsubscription)

- [了解 Azure RBAC](/azure/role-based-access-control/overview)
...
- [如何配置条件性访问以阻止访问 ARM](/azure/role-based-access-control/conditional-access-azure-management)
...
- [了解 Azure Policy 效果](/azure/governance/policy/concepts/effects)
...
- [如何在 Azure 安全中心修正建议](/azure/security-center/security-center-remediate-recommendations)
...
- [静态数据的 Azure 存储加密](/azure/storage/common/storage-service-encryption)
...
- [如何使用托管标识授予对 Azure blob 和队列数据的访问权限](/azure/storage/common/storage-auth-aad-rbac-portal)
...
- [了解 Azure 存储冗余和服务级别协议](/azure/storage/common/storage-redundancy)

- [创建 blob 的快照](/rest/api/storageservices/creating-a-snapshot-of-a-blob)

- [Azure 自动化概述](/azure/automation/automation-intro)
...
- [为 Blob 存储设置和管理不可变性策略](/azure/storage/blobs/storage-blob-immutability-policies-manage?tabs=azure-portal)
...
- [AzCopy 是一个命令行实用工具，可用于在存储帐户中复制 blob、文件和表数据](/azure/storage/common/storage-use-azcopy-v10)
...
- [Azure 存储 Blob 的软删除](/azure/storage/blobs/storage-blob-soft-delete?tabs=azure-portal)

- [使用不可变的存储来存储业务关键型 Blob 数据](/azure/storage/blobs/storage-blob-immutable-storage)
...
- [如何配置连续导出](/azure/security-center/continuous-export)
...
- [如何配置工作流自动化和逻辑应用](/azure/security-center/workflow-automation)
...
- 参阅 [Azure 安全基准](/azure/security/benchmarks/overview)
