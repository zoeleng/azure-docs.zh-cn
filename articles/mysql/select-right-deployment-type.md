...
|:-------------------|:-------------------------------------------|:---------------------------------------------|:---------------------------------------|
| MySQL 版本支持 | 5.6、5.7 和 8.0| 5.7 | 任何版本|
...
| 群队管理 | 支持 Azure CLI、PowerShell、REST 和 Azure 资源管理器 | 支持 Azure CLI、PowerShell、REST 和 Azure 资源管理器  | 支持 Azure CLI、PowerShell、REST 和 Azure 资源管理器的 Vm |
