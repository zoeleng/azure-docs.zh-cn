...
在应用程序网关上使用 [az 网络应用程序网关重定向-config create](/cli/azure/network/application-gateway/redirect-config#az-network-application-gateway-redirect-config-create)，将流量从 *www \. consoto.org* 发送到 *侦听器的重 \.* 定向配置。
