...
有关 Key Vault 数据平面安全性的详细信息，请参阅 [Key Vault 数据平面和访问策略](./secure-your-key-vault.md#data-plane-and-access-policies) 和 [Key Vault 数据平面和 RBAC (预览) ](./secure-your-key-vault.md#data-plane-and-azure-rbac-preview)
