...
![屏幕截图显示选定的 "Over" 选项卡上的窗口设置。](media/data-flow/windows4.png "windows 4")

## <a name="sort"></a>排序
Over 子句的另一部分是设置 ```Order By```。 该操作将设置数据排序顺序。 还可以在此列字段中为计算值创建表达式以进行排序。

![屏幕截图显示选中了 "排序" 选项卡的窗口化设置。](media/data-flow/windows5.png "windows 5")
...
![屏幕截图按选定的 "范围" 选项卡显示窗口设置。](media/data-flow/windows6.png "windows 6")

## <a name="window-columns"></a>窗口列
最后，使用表达式生成器定义你希望与数据窗口一起使用的聚合，例如 RANK、COUNT、MIN、MAX、DENSE RANK、LEAD 和 LAG 等。

![屏幕截图显示窗口操作的结果。](media/data-flow/windows7.png "windows 7")
