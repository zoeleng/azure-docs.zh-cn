...
* [如何从 Azure Monitor 中的 Azure 虚拟机收集数据](../azure-monitor/learn/quick-collect-azurevm.md)

* [在 Azure 安全中心启用数据收集](../security-center/security-center-enable-data-collection.md#data-collection-tier)
...
* [如何配置和管理 Azure SQL 数据库的 Azure Active Directory 身份验证](../azure-sql/database/authentication-aad-configure.md)
...
* [如何使用 Azure SQL Server 的数据发现和分类](../azure-sql/database/data-discovery-and-classification-overview.md)
...
* [了解 Azure 数据工厂中的传输加密](./data-movement-security-considerations.md)
...
* [如何 Azure Key Vault 中的凭据](./store-credentials-in-key-vault.md)
...
* [如何启用高级数据安全性](../azure-sql/database/azure-defender-for-sql.md)
...
* [了解虚拟机的集成漏洞扫描程序](../security-center/deploy-vulnerability-assessment-vm.md)
