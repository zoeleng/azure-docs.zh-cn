...
| `python` | [`PythonSection`](/python/api/azureml-core/azureml.core.environment.pythonsection?preserve-view=true&view=azure-ml-py)hat 定义要在目标计算资源上使用的 Python 环境和解释器。 |
