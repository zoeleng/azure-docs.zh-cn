...
> [!NOTE]
>如果 SSO 登录要求管理员授予对应用的权限，则合作伙伴中心提供的产品/服务的说明必须公开管理员级别的访问权限。 这是为了符合 [商业应用商店认证策略](/legal/marketplace/certification-policies#10003-authentication-options)。
...
在此流中，客户从 Azure 门户或 M365 管理中心更改订阅计划或座位数量。  
