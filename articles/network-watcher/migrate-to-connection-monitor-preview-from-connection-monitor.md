...
ms.locfileid: "94699061"
---
# <a name="migrate-to-connection-monitor-from-connection-monitor"></a>从连接监视器迁移到连接监视器

只需单击几下鼠标，就能将现有连接监视器迁移到新的、经过改进的连接监视器，并且无需停机。 若要了解有关这些优势的详细信息，请参阅 [连接监视器](https://docs.microsoft.com/azure/network-watcher/connection-monitor-preview)。
...
* 指标警报会迁移到连接监视器指标警报。 度量值不同，因此进行了更改。 有关详细信息，请参阅 [带连接监视器的网络连接监视](https://docs.microsoft.com/azure/network-watcher/connection-monitor-preview#metrics-in-azure-monitor)。
...
* [从网络性能监视器迁移到连接监视器](migrate-to-connection-monitor-preview-from-network-performance-monitor.md)
