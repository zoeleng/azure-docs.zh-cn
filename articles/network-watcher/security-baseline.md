...
* [了解网络观察程序中的 Azure RBAC 权限](https://docs.microsoft.com/azure/network-watcher/required-rbac-permissions)
...
* [另请参阅：如何配置和管理 Azure Policy](https://docs.microsoft.com/azure/governance/policy/tutorials/create-and-manage)
